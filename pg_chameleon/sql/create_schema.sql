    ...
    BEGIN
        ...
        LOOP
            ...
            EXCEPTION
                ...
                RAISE NOTICE 'Replay failed for table %.%',v_r_statements.v_schema_name,v_r_statements.v_table_name;
                ...
                THEN
                    RAISE EXCEPTION 'Replay failed for table %.%: % - %', v_r_statements.v_schema_name, v_r_statements.v_table_name, SQLSTATE, SQLERRM;
                ELSE
