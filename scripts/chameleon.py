...
foreground_help = """Runs daemonised commands in the foreground with logging on stdout, without forcing debug log level."""
...
log_replay_statements_help = """With start_replica, logs each SQL statement generated by the replay process."""
...
parser.add_argument('--foreground', default=False, required=False, help=foreground_help, action='store_true')
...
parser.add_argument('--log-replay-statements', default=False, required=False, help=log_replay_statements_help, action='store_true')
